<form class="cmxform form-horizontal tasi-form" id="commentForm" method="POST" action="<?php echo site_url() . '/admin/nilai_kepribadian/tambah_nilai' ?>">
      ...
      <div class="col-md-12">
        ...
        <div class="col-md-5">
          ...
          <div class="form-group">
            ...
            <input type="text" name="ket_ekstra" class="form-control">
          </div>
        </div>
        ...
        <div class="col-md-5">
          ...
          <div class="form-group">
            <label>Izin</label>
            <input type="text" name="izin" class="form-control" value="0">
          </div>
          <div class="form-group">
            <label>Tanpa Keterangan</label>
            <input type="text" name="tanpa" class="form-control" value="0">
          </div>
        </div>
      </div>
    </div>
